...
\def\tatitle{RANCANG BANGUN PERANGKAT LUNAK INTEGRASI DATA PADA SISTEM INFORMASI RUMAH SAKIT DENGAN MENGGUNAKAN METODE ELT (EXTRACT, LOAD, TRANSFORM)}
